  ...
  const NotesSection = () => {
    ...
    if (selectedPdfUrl) {
      ...
      <div className="flex flex-col h-[calc(100vh-80px)] -mx-8 -mb-12 overflow-hidden bg-[#0a0f1d] absolute inset-0 z-50">
        {/* Header bar */}
        <div className="h-20 bg-[#0a0f1d] border-b border-white/5 px-4 md:px-8 flex flex-col md:flex-row items-center justify-between shrink-0 gap-3 py-2 md:py-0 top-0 sticky z-50">
        ...
        <div className="flex-1 w-full bg-zinc-950 overflow-hidden flex flex-col lg:flex-row relative min-h-[500px]">
          {selectedPdfUrl.includes('supabase.co') && (
            <div className="w-full lg:w-96 bg-[#0a0f1d] border-b lg:border-b-0 lg:border-r border-white/10 p-5 overflow-y-auto shrink-0 flex flex-col justify-between z-10 text-left">
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-white/5 border border-white/5 rounded-xl p-3">
                    ...
                    <p className="text-[10px] text-zinc-400 leading-relaxed">
                      You can also upload active PDF or file links from Google Drive/Dropbox via your Student Portal notes section!
                    </p>
                  </div>
                </div>
              </div>
