...
export const Dashboard: React.FC<{ defaultView?: string }> = ({ defaultView = 'dashboard' }) => {
  ...
  const NotesSection = () => {
    ...
    if (selectedPdfUrl) {
      return (
      <div className="flex flex-col h-[calc(100vh-80px)] -mx-8 -mb-12 overflow-hidden bg-zinc-900 absolute inset-0 z-50">
        <div className="h-20 bg-[#0a0f1d] border-b border-white/5 px-8 flex items-center justify-between shrink-0 top-0 sticky z-50">
          <div className="flex items-center gap-4">
            <button 
        ...
        <div className="flex-1 w-full bg-zinc-900 overflow-hidden relative min-h-screen">
          <iframe 
